...
| `design-ocr` | https://raw.githubusercontent.com/contactkwos-sys/jaisal-fw-lite/main/supabase/functions/design-ocr/index.ts | Optional legacy — **DIN Costing now uses browser Tesseract.js** (no API key) |
...
**DIN Costing Design Import** reads sheets in the browser with **Tesseract.js** (free, no Supabase secret). Fields stay editable when auto-read is incomplete.
