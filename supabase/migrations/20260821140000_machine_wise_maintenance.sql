...
-- Backfill technician from assigned_to where empty
...
-- Add FK from breakdown parts → spare parts (after spare table exists)
do $$
begin
  if not exists (
...
-- ---------- Seed default schedules for M1–M6 if empty ----------
