...
-- Self-contained catalog of design + matching photos for WhatsApp sharing.
-- Does not alter Production, Inventory, or Order modules.
...
-- Storage bucket: design-catalog-images (public read, authenticated write)
