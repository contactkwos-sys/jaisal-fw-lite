-- Purchase & Inward rebuild: general / weft multi-item / maintenance inward / repair invoices
...
-- quality/weight_kg/rate remain for backward compat; multi-row items live here
...
-- Storage: purchase-photos (public read, authenticated write)
