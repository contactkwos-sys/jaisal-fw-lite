-- Cash Book — cashbook_entries
-- Mirror: public/migration-cashbook.sql
...
-- Update only when CEO PIN flow stamps edit_approved_by
...
-- Delete only after approval stamp (UI verifies CEO PIN, then stamps, then deletes)
