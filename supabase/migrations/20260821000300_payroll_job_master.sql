-- Payroll Master Job List (designations for payroll / attendance)
-- Max 50 active job titles. Idempotent seed of required security/sweeper jobs.
...
-- Required job titles (keep existing rows; insert missing only)
