...
function mapRow(r: Record<string, unknown>): QualityMasterRow {
  return {
    ...
    default_width: n(r.default_width) || DEFAULT_WIDTH,
    default_length_mtr: n(r.default_length_mtr) || DEFAULT_LENGTH_MTR,
    default_tar_ends: n(r.default_tar_ends) || DEFAULT_TAR_ENDS,
