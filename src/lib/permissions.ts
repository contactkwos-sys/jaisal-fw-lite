...
const ROLE_DEFAULTS: Record<string, MainModuleId[]> = {
  ...
  'mill incharge': ['production', 'inventory', 'cash-book', 'hr-payroll', 'orders', 'reports', 'maintenance'],
  mill: ['production', 'inventory', 'cash-book', 'hr-payroll', 'orders', 'reports', 'maintenance'],
