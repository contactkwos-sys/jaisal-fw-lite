    ...
    items: [
      {
        ...
        screen: 'security-machine-production',
        hint: 'Security mobile — M1–M6 run + meters + WhatsApp',
      },
      {
...
export const PAGE_TITLES: Record<AppScreen, string> = {
  ...
  'security-machine-production': 'Machine & Production Update',
  'module-hub': 'Module',
...
export function moduleForScreen(screen: AppScreen, sub?: string, filter?: string): MainModuleId {
  ...
  if (screen === 'security-inventory' || screen === 'security-machine-production') return 'security'
...
export function titleFor(screen: AppScreen, sub?: string, moduleId?: MainModuleId, filter?: string): string {
  ...
  if (screen === 'security-machine-production') return 'Machine & Production Update'
